...
export class AuthService {
    ...
    constructor(
        ...
        this.oauthService.events
            .pipe(filter(e => ['token_expires'].includes(e['type']) && ['access_token'].includes(e['info'])))
            .subscribe(e => this.oauthService.refreshToken());
    }
    ...
    public runInitialLoginSequence(): Promise<void> {
        ...
        return this.oauthService.loadDiscoveryDocument()
            ...
            .then(() => {
                ...
                // 2. if the user has a refresh token registered, we try to ask for a refresh
